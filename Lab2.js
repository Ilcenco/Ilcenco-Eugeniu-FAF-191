...
var Shape = function () {
    ...
    this.makeCircle = function(height, steps) {
        //var steps = 60;
...
var Cylinder = function() {
    Shape.call(this);
    this.distance = [-0.14, 0.0, 0.0];
    this.name = "Cylinder" + nextShapeId["cylinder"]++;


    var vTop = vec4( 0.0,  l, 0.0, 1.0);
    var vBot = vec4( 0.0, -l, 0.0, 1.0);
    var vecsTop = this.makeCircle(l, 60);
    var vecsBot = this.makeCircle(-l, 60);
